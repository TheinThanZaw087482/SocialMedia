...
(21, '2025-05-19 23:22:25', '2321067', 'hi', NULL, NULL, 'public', NULL, NULL, NULL, NULL),
...
(28, '2025-05-22 20:42:35', '2321067', 'test', NULL, NULL, 'public', NULL, NULL, NULL, '1747923155_682f30d362c8b.png');
...
CREATE TABLE `users` (
  ...
  `ProfileimagePath` varchar(255) DEFAULT 'porfileimage.png',
  `coverPhoto` varchar(255) DEFAULT 'porfileimage.png',
...
('2321067', 'Thein', 'sanminhtike9289@gmail.com', '$2y$10$oGOatOAszg7RuxAzzXnotepfIXZVZozGQN5GLZryrRv0A1gdlpW8G', 'male', '2025-05-01', '1747934554_682f5d5a3099d.png', '1747932535_682f55777e8f9.jpg', NULL, 'bt11', 0, '2025-05-16 10:41:39');
...
--
ALTER TABLE `reaction`
  MODIFY `reactionID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;

...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $reactionType = isset($data['reactionType']) ? $data['reactionType'] : null; // This can now be NULL
    ...
    if ($reactionType !== null) {
        $allowedReactions = ['Like', 'Heart', 'Haha', 'Wow', 'Sad', 'Angry']; // Match your button titles
    ...
    try {
        // --- Record the View and/or Reaction in the single table ---
        // Insert a new view or update an existing one.
        // If a reactionType is provided, it updates that column.
        // If no reactionType is provided (it's NULL), it will keep it NULL or update to NULL.

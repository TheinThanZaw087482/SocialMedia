    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="notification d-flex align-items-center p-2 border-bottom">
                <img src="./img/bbh.avif" alt="user" style="width: 40px; height: 40px; border-radius: 50%; margin-right: 10px;">
                <div class="content flex-grow-1">
                    <div class="text"><strong>Su Latt</strong> and <strong>Myo Aung</strong> reacted to a video.</div>
                    <div class="time text-muted small">13h</div>
                </div>
        ...
        <div class="notification d-flex align-items-center p-2 border-bottom">
            ...
            <div class="content flex-grow-1">
                <div class="text"><strong>Su Latt</strong> and <strong>Myo Aung</strong> reacted to a video.</div>
                <div class="time text-muted small">13h</div>
                <button type="button" class="btn btn-sm btn-outline-primary mt-1" data-bs-toggle="modal" data-bs-target="#videoModal">
                    View Info
                </button>
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="videoModalLabel">User Info</h5>
                        ...
                        <div class="modal-body">
                            <form method="POST" action="../process/editprofile.php" enctype="multipart/form-data">
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" name="profileId" value="2112073" readonly>
                                </div>
                                <div class="mb-2">
                                    <label for="profileName" class="form-label">Username</label>
                                    <input type="text" class="form-control" name="profileName" value="Myo Aung">
                                </div>
                                <div class="mb-2">
                                    <label for="profileEmail" class="form-label">Email</label>
                                    <input type="email" class="form-control" name="profileEmail" id="profileEmail" value="myoaung@gmail.com">
                                </div>
                                <div class="mb-2">
                                    <label for="profileGender" class="form-label">Gender</label>
                                    <input type="text" class="form-control" name="profileGender" id="profileGender" value="Female">
                                </div>
                                <div class="mb-2">
                                    <label for="profileBatch" class="form-label">Batch</label>
                                    <input type="text" class="form-control" name="profileBatch" id="profileBatch" value="Batch11">
                                </div>
                                <div class="mb-2">
                                    <label for="profileBirthday" class="form-label">Birthday</label>
                                    <input type="date" class="form-control" name="profileBirthday" id="profileBirthday">
                                </div>
                                <div class="mb-2">
                                    <label for="profileRole" class="form-label">Role</label>
                                    <select id="profileRole" name="profileRole" class="form-select">
            ...
            <div class="menu-icon dropdown ms-auto" style="padding-left: 10px;"> <a href="#" class="dropdown-toggle text-decoration-none" data-bs-toggle="dropdown" aria-expanded="false">
                    <i class="fa-solid fa-bars"></i>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item " href="#">Delete the notification</a></li>
